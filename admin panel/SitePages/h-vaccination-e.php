                                    ...
                                    <div class="col-md-12 patients-details-card-wrapper">
                                        <div class="mini-card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group"><label>Test Id</label><input class="form-control" name="id" readonly="readonly" value="<?php echo $data1['id']; ?>" required></div>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group"><label>appointment Date</label><input class="form-control" name="doa" value="<?php echo $data1['date_of_appointment']; ?>" required></div>
                                                    </div>
                                                    <div class="col-md-4">
