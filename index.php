                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <strong>COVID-19 </strong>is caused by the SARS CoV-2 Virus. It is spread through droplets released when a person coughs or sneezes.It results in a mild to moderate respiratory infection, however, it may lead to severe pneumonia, organ failure and can be fatal, especially in the elderly or those who suffer from chronic diseases or are immunocompromised.
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            <b>How to protect yourself from getting COVID-19 infection.?</b>
                        </button>
                    </h2>
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ul>
                                <li>Wash your hands frequently with soap, particularly after coughing or sneezing.</li>
                                <li>Cough or sneeze in a tissue or your elbow. Do not re-use tissues and discard them safely in a dustbin.</li>
                                <li>Refrain from touching your mouth, eyes and nose.</li>
                                <li>Maintain a physical distance of at least 6 feet from other people; stay home.</li>
                                <li>If you have a cold or flu symptoms or are outside with other people around you, wear a surgical mask.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            <b>If you feel sick with COVID-19 symptoms of cough, fever and difficulty in breathing.</b>
                        </button>
                    </h2>
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ul>
                                <li>If symptoms are mild, immediately self-quarantine at home.</li>
                                <li>If symptoms are moderate call SCH and seek assistance from our health care professionals.</li>
                                <li>In case of severe symptoms, consult a doctor and rush to ER.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">
                            <b>If you want to get tested for COVID-19.</b>
                        </button>
                    </h2>
                    <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            Please call-in to our separate and dedicated testing area for COVID-19 for a <strong>PCR test.</strong>
                        </div>
                    </div>
                </div>
            </div>
